...
**Plans**: 4 plans
Plans:
- [x] 07-01-PLAN.md — Wave 0: Test scaffold (entityPages.test.ts — it.todo stubs for SYS-01, SYS-02, OWN-01, OWN-02)
- [x] 07-02-PLAN.md — Wave 1: Systems.tsx page + SYS tests GREEN (SYS-01, SYS-02)
- [x] 07-03-PLAN.md — Wave 1: Owners.tsx page + OWN tests GREEN (OWN-01, OWN-02) — parallel with 07-02
...
**Plans**: 3 plans
Plans:
- [ ] 08-01-PLAN.md — Wave 0: Test scaffold (crossLinking.test.ts — deriveRelated full assertions + it.todo stubs for LINK-01/02/03)
...
| 8. Cross-Linking | 0/3 | Not started | - |
