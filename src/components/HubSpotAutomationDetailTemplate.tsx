import { AlertTriangle, ArrowRight, CheckCircle2, CircleDot, ExternalLink, ShieldAlert, Info } from "lucide-react";
...
// Dunne wrapper voor bestaande imports: de kaart zelf is verplaatst naar
// `AutomationWhatHappensCard` (zie dat bestand), omdat de onderliggende
// `ai_enrichment`-velden altijd al bron-onafhankelijk waren — alleen de kaart
// bestond nog niet buiten HubSpot. `AutomationDetailPage.tsx` gebruikt inmiddels
// het gedeelde component rechtstreeks, voor alle vier de bronnen.
export function HubSpotWhatHappensCard({ automation }: { automation: Automatisering }): React.ReactNode {
  return <AutomationWhatHappensCard automation={automation} />;
}
...
// De vroegere `WatGebeurtErCard`/`WhatHappensRow` staan nu in
// `AutomationWhatHappensCard.tsx` (bron-onafhankelijk, zie daar).
