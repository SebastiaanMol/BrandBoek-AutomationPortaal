...
await page.screenshot({ path: 'tmp/imports-stage-id-live-initial-profile.png', fullPage: true });
...
await page.screenshot({ path: 'tmp/imports-stage-id-live-search-profile.png', fullPage: true });
